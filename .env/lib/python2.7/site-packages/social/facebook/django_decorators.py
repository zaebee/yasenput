...
from social.facebook.facebook import Facebook, FacebookError
from social.facebook.settings import DIALOG_URL, DIALOG_PARAMS, CSRF_TOKEN_REQUIRED
...
def facebook_callback(fun):
    ...
    def inner(request, *args, **kwargs):
        ...
        if error is None:
            ...
            from social.facebook.signals import post_facebook_auth
            post_facebook_auth.send('social.facebook', token=access_token)

...
from apps.trips.models import Blocks
...
urlpatterns = patterns('',
    ...
    url(r'^block$', PhotosList.as_view(model=Blocks), name='photos_event_list'),
    ...
    url(r'^block/(\d+)/add$', PhotosAdd.as_view(model=Blocks), name='photos_event_add'),

...
function update_multisearch() {
    ...
    function(res) {
        ...
        compiled = multisearch_places_tmpl({
            data: window.multisearch_data.places
        });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            compiled = multisearch_points_tmpl({
                data: data
            });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var compiled = multisearch_users_tmpl({
                data: data
            });
            ...
            // add id to each element
            i = 0
            _.each($("#multisearch-users ._item_ a"), function(item) {
                $.data(item, "id", i);
                i++
            });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var compiled = multisearch_tags_tmpl({
                data: data
            });
            ...
            // add id to each element
            i = 0
            _.each($("#multisearch-tags ._item_ a"), function(item) {
                $.data(item, "id", i);
                i++
            });

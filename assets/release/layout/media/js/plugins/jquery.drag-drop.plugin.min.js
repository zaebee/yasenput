...
k.onStart);return this},destroy:function(){this.unbind("mousedown.dragdrop touchstart.dragdrop");return this},on:function(){this.data("options").isActive=!0},off:function(){this.data("options").isActive=!1},onStart:function(a){var g=i(this),b=g.data("options");if(b.isActive){var f=b.canDrag(g,a);if(f){h=f;var d=h.position(),e=h.width(),l=h.height();"touchstart"==a.type?(m=a.originalEvent.touches[0].clientX-d.left,n=a.originalEvent.touches[0].clientY-d.top):(m=a.pageX-d.left,n=a.pageY-d.top);b.makeClone?
(c=h.clone(!1),c.appendTo(f.parent()),b.sourceClass?h.addClass(b.sourceClass):b.sourceHide&&h.css("visibility","hidden")):c=h;c.css({position:"absolute",left:d.left,top:d.top,width:e,height:l});b.dragClass&&c.addClass(b.dragClass);if(b=b.container)d=b.position(),j={minX:d.left,minY:d.top,maxX:d.left+b.outerWidth()-f.outerWidth(),maxY:d.top+b.outerHeight()-f.outerHeight()};i(window).bind("mousemove.dragdrop touchmove.dragdrop",{source:g},k.onMove).bind("mouseup.dragdrop touchend.dragdrop",{source:g},

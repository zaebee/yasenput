@Yapp.module 'AddPopupApp.Route', (Route, App, Backbone, Marionette, $, _) ->
  ...
  class Route.Layout extends App.Views.Layout
    template: 'AddRouteLayout'
    className: 'popupwin__scrollbox'
    
    regions:
      stepNameRegion: '#route-name-region'
      stepWhatRegion: '#route-what-region'
  ...
  class Route.StepName extends App.Views.Layout
    template: 'RouteStepName'
    regions:
  ...
  class Route.StepWhat extends App.Views.ItemView
    template: 'RouteStepWhat'
  ...
  class Route.StepCommers extends App.Views.ItemView
  ...
  class Route.Imgs extends App.Views.ItemView
    template: 'ImgsList'
    modelEvents:
      'change:imgs': 'render'
